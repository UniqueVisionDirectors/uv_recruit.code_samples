    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "06 スケールとロードバランサー", link: "/06-scale-lb" },
          { text: "07【問題②】衝突を観測", link: "/07-exercise-collision" },
          { text: "08【解答例②】worker-id 設計", link: "/08-solution-workerid" },
          { text: "09 付録", link: "/09-appendix" },
        ],
      },
    ],
